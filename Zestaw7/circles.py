...
class Circle:
    ...
    def cover(self, other):    # okrąg pokrywający oba
        radius = math.sqrt(math.pow(self.pt.x - other.pt.x, 2) +
                           math.pow(self.pt.y - other.pt.y, 2))
...
class TestCircle(unittest.TestCase):
    ...
    def test_cover(self):
        self.assertEqual(Circle(0, 0, 2).cover(
            Circle(0, 2, 2)), Circle(0, 1, 2))
        self.assertEqual(Circle(0, 0, 2).cover(
            Circle(2, 2, 2)), Circle(1.0, 1.0, math.sqrt(8)))
